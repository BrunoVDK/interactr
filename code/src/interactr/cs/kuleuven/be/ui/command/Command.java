...
public abstract class Command {
    ...
    /**
     * Execute this command in the given dialog window.
     *
     * @param dialog The dialog window in which the command should be executed.
     * @throws CommandNotProcessedException the command could not be executed by the given receiver.
     */
    public void executeDialogWindow(DialogWindow dialog) {throw new CommandNotProcessedException();}
